...
void displayLoginScreen() {
    ...
    cout << "1. Admin" << endl;
    cout << "2. User" << endl;
    cout << "3. Lihat Akun Tersedia" << endl;
    cout << "0. Keluar" << endl;
    cout << "Pilihan Anda: ";
}
...
void displayAdminMenu() {
    cout << "\n╔════════════════════════════════════════╗" << endl;
    cout << "║        MENU ADMIN - KELOLA SEMUA      ║" << endl;
    cout << "╚════════════════════════════════════════╝" << endl;
    ...
    cout << "7. Lihat Akun Tersedia" << endl;
    cout << "0. Logout" << endl;
    cout << "Pilihan Anda: ";
}
...
void displayUserMenu() {
    cout << "\n╔════════════════════════════════════════╗" << endl;
    cout << "║      MENU USER - HANYA LIHAT & SEWA   ║" << endl;
    cout << "╚════════════════════════════════════════╝" << endl;
...
int main() {
    ...
    while (true) {
        ...
        if (loginChoice == 3) {
            authManager.printAvailableUsers();
            continue;
        }
        ...
        if (loggedInUser == NULL) {
            cout << "\nCoba lagi atau lihat akun yang tersedia (Pilihan 3)" << endl;
            continue;
        }
        ...
        if (loggedInUser->getRole() == ADMIN) {
            while (true) {
                ...
                switch (mainChoice) {
                    ...
                    case 2: {
                        // Kelola Data Penyewa (ADMIN ONLY)
                        while (true) {
                            displayRenterMenu();
                            cin >> renterChoice;
                            cin.ignore();
